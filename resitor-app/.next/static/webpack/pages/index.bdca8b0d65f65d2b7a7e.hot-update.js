...
/* WEBPACK VAR INJECTION */(function(module) {// Override http config
module.exports.api = {
...
/***/ "./services/api/resistorApiCall.js":
false,
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return _context.abrupt("return", _axios["default"].post("".concat(config.api.url, "/calculateResistance"), obj));
